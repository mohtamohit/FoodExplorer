		...
		<div class="w3l_banner_nav_right">
			...
			<div class="agileinfo_single">
				...
				<div class="col-md-4 agileinfo_single_left">
					<img id="example" src="<?php echo $product['picture']; ?>" alt=" " class="img-responsive" />
				</div>
				<div class="col-md-8 agileinfo_single_right">
					...
					<div class="snipcart-item block">
						<div class="snipcart-thumb agileinfo_single_right_snipcart">
							<h4><?php echo "Rs. " . $product['unit_price']; ?> <span><?php echo "Rs. " . (1.1)*$product['unit_price']; ?> </span></h4>
						</div>
						<div class="snipcart-details agileinfo_single_right_details">
							<form action="#" method="post">
								<fieldset>
									...
									<a href="target.php?id=<?php echo $product[0]; ?> "> 
													Add to cart</a>
								</fieldset>
							</form>
						</div>
...
<?php if(!isset($_SESSION["email_id"])){
	$_SESSION['lastloc'] = "pd.php?pid=" . $arr[0];
}
?>
